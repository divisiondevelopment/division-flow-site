...
const badges = [
  { text: "Gestão de Projetos", top: "15%", left: "5%" },
  { text: "Hub de Clientes", top: "25%", right: "8%" },
  { text: "Contratos Inteligentes", top: "60%", left: "10%" },
  { text: "Controle de Cobranças", top: "70%", right: "18%" },
];
...
const Hero = () => {
  const badge = "Conheça o Division Flow";
  const description =
    "Gerencie leads, feche contratos e entregue projetos no prazo. Tudo automatizado. Sem mensalidade absurda.";
      ...
      <Wrapper className="relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-semibold tracking-tight font-heading mt-8">
            <Balancer>
              {"Organize seu negócio".split(" ").map((word, index) => (
                <motion.span
              ...
              <br />
              {"de forma simplificada".split(" ").map((word, index) => (
                <motion.span
                  initial={{ filter: "blur(10px)", opacity: 0, y: 10 }}
                  animate={{ filter: "blur(0px)", opacity: 1, y: 0 }}
        ...
        >
          <div className="relative mx-auto max-w-6xl rounded-2xl md:rounded-[32px] border border-foreground/10 bg-foreground/5 backdrop-blur-lg p-2">
            ...
            <div className="rounded-lg md:rounded-[24px] border border-foreground/10 bg-background overflow-hidden">
              <Image
                src="/images/dashboard-div-flow.jpeg"
