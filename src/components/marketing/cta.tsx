        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          >
            ...
            <div
              ...
              style={{
                maskImage:
                  "radial-gradient(ellipse 70% 50% at 50% 50%, transparent 40%, white 70%)",
                WebkitMaskImage:
                  "radial-gradient(ellipse 70% 50% at 50% 50%, transparent 40%, white 70%)",
              }}
            />
            ...
            <div className="relative z-40 flex flex-col items-center text-center py-16 lg:py-20 px-6">
              ...
              >
                ...
                />
                <span className="text-2xl font-bold bg-linear-to-r from-primary to-primary/70 text-transparent bg-clip-text">
                  Division Flow
                </span>
              </motion.div>
              ...
              >
                Junte-se a freelancers e agências que já <br /> organizam seus
                negócios aqui
              </motion.p>
